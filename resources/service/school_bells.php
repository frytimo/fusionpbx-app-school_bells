...
/**
 * School Bells Service
 * Polls school bell data and broadcasts via websockets
 */
...
define('SERVICE_NAME', school_bells_service::get_service_name());

set_time_limit(55);  // Cannot run more than 55 seconds

try {
	$service = school_bells_service::create();
